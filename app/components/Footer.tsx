...
export default function Footer() {
  return (
    <footer style={{ background: "#cdcdcd" }} className="text-black/80">
      {/* Accent bar */}
      <div style={{ background: "#23604A" }} className="h-1" />
      ...
      <div className="max-w-7xl mx-auto px-8 py-12 grid grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-10">
        ...
        <div className="col-span-2 lg:col-span-1 flex flex-col justify-center gap-3 items-center">
          ...
          <div className="flex items-center gap-2 mt-1">
            <a
              ...
              className="flex items-center justify-center w-9 h-9 rounded-full bg-black/10 text-black/55 hover:bg-[#23604A] hover:text-white transition-all duration-200"
            >
          ...
          <ul className="space-y-2 text-sm">
            {links.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="text-black/65 hover:text-[#23604A] transition-colors"
                >
                  {link.label}
                </Link>
              </li>
        ...
        <div className="hidden lg:block">
          ...
          <ul className="space-y-2 text-sm text-black/65">
            <li>
              <a href="tel:+553132417101" className="hover:text-[#23604A] transition-colors">
                (31) 3241-7101
              </a>
            </li>
            <li>
              <a
                ...
                className="hover:text-[#23604A] transition-colors break-all"
              >
