...
export default function Footer() {
  return (
    <footer style={{ background: "#cdcdcd" }} className="text-black/80">
      {/* Accent bar */}
      <div style={{ background: "#1a5934" }} className="h-1" />
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-2 mt-1">
            <a
              ...
              className="flex items-center justify-center w-9 h-9 rounded-full bg-black/10 text-black/55 hover:bg-[#1a5934] hover:text-white transition-all duration-200"
            >
          ...
          <ul className="space-y-3">
            {links.map((link) => (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className="group flex items-center gap-2.5 text-sm text-black/65 hover:text-[#1a5934] transition-colors duration-200"
                >
                  <span className="block h-px w-4 bg-black/25 group-hover:w-6 group-hover:bg-[#1a5934] transition-all duration-200" />
                  {link.label}
                </Link>
              </li>
            ))}
        ...
        <div>
          ...
          <address className="not-italic space-y-4 mb-6">
            <p className="flex items-start gap-2.5 text-sm text-black/65">
              <svg className="w-4 h-4 mt-0.5 shrink-0 text-[#1a5934]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <p className="flex items-center gap-2.5 text-sm text-black/65">
              <svg className="w-4 h-4 shrink-0 text-[#1a5934]" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href="tel:+553132417101" className="hover:text-[#1a5934] transition-colors duration-200">
                (31) 3241-7101
              </a>
            </p>
          </address>
